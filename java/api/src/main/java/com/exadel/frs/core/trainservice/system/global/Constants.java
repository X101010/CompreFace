...
public class Constants {
    ...
    public static final String TIME_REQUEST_PARAM = "time";
    ...
    public static final String TIME_DESC = "A period of time to query";
    public static final String PREDICTION_COUNT_MIN_DESC = "prediction_count should be equal or greater than 1";
    public static final String TIME_MIN_DESC = "time should be equal or greater than 1";
